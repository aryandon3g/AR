...
export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-3.75h1.5m-1.5 3h1.5m-1.5 3h1.5M18 10.5a3 3 0 11-6 0v-3c0-1.337 2.373-2.404 4.5-2.008zM12 6.75c1.472 0 2.87.545 3.923 1.509a2.493 2.493 0 00-4.004 0A6.866 6.866 0 0112 6.75zM18 19.5h-7.5c-1.125 0-2.025-.9-2.025-2.025v-1.35c0-.834.42-1.577 1.072-2.025l.896-.64A1.125 1.125 0 0112 13.5h.5v-1.25c0-.847.785-1.543 1.625-1.464l.896.096c.652.071 1.072.766 1.072 1.594v1.25H18c.997 0 1.834.733 1.954 1.71l.004.032c.112.923-.591 1.713-1.583 1.713z" />
    </svg>
);
