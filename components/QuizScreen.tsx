...
      <div 
        ref={cardRef}
        className={`flex-grow min-h-0 **pb-20** ${animationClass}`}
...
      {/* NAVIGATION BUTTONS - Made Transparent and Fixed */}
      <div className="**absolute inset-x-0 bottom-4 px-4** flex items-center justify-between **opacity-0 pointer-events-auto**">
        <button
